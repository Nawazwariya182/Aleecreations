...
export default function Collection() {
  ...
  const products: Product[] = [
    ...
    {
      id: 8,
      name: "Ginkgo Leaf Luster (1 Piece)",
      SKU: "CHACLX008-ML",
      price: 99,
    ...
    {
      id: 14,
      name: "Golden Teardrop Elegance (Any 1)",
      SKU: "CHCRLX014-GD",
      price: 79,
    ...
    {
      id: 16,
      name: "Bespoke Pastel Charm (Any 1 Design)",
      SKU: "CHACPS016-PS",
      price: 149,
    ...
    {
      id: 31,
      name: "Luminous Band (Any 1 Color)",
      SKU: "CHCRLX031-ML",
      price: 299,
    ...
    },
    {
      ...
      SKU: "CHPLCT046-WH",
      price: 479,
      description: "Premium faux pearl ring with glossy white bow.",
    ...
    },
    {
      ...
      SKU: "LSCRLX047-PK",
      price: 519,
      description: "Elegant pink crystal crossbody chain with luxe shimmer.",
    ...
    {
      id: 48,
      name: "Pearl Bow Tassel",
      SKU: "CHPLLX048-WH",
      price: 499,
      description: "Lustrous pearl bow with elegant tassel ends.",
    ...
    },
    {
      ...
      SKU: "BPPLPS049-PK",
      price: 469,
      description: "Premium safety pin with pink stars and pearls.",
    ...
    {
      id: 50,
      name: "Y2K Baddie Keychain",
      SKU: "CHACCT050-ML",
      price: 439,
      description: "Edgy Y2K keychain with premium charms.",
    ...
    {
      id: 51,
      name: "Bespoke Pastel Pin (Any 1 Design)",
      SKU: "BPPLPS051-PS",
      price: 99,
              ...
              {filteredProducts.map((product) => (
                ...
                >
                  ...
                  <div className="p-2 sm:p-3 md:p-4 lg:p-5">
                    <h3 className="font-gatheraz text-[11px] sm:text-md md:text-lg lg:text-xl xl:text-xl 2xl:text-xl text-charcoal tracking-wide mb-0.5 sm:mb-1 md:mb-2 line-clamp-1">
                      {product.name}
                    </h3>
