...
export default function Products() {
  ...
  const products: Product[] = [
    ...
    },
    {
      ...
      SKU: "CHPLCT046-WH",
      price: 479,
      description: "A chic and compact charm featuring a ring formed by large white faux pearls, topped with a glossy white resin bow.",
    ...
    },
    {
      ...
      SKU: "LSCRLX047-PK",
      price: 519,
      description: "A long, elegant chain designed for crossbody wear with faceted light pink crystal beads.",
    ...
    },
    {
      ...
      SKU: "CHPLLX048-WH",
      price: 499,
      description: "A unique structural accessory crafted entirely from lustrous white pearls forming a bow with tassel ends.",
    ...
    },
    {
      ...
      SKU: "BPPLPS049-PK",
      price: 469,
      description: "A playful pin accessory with dangling chains, pink star beads, white pearls, and a clear flower charm.",
    ...
    },
    {
      ...
      SKU: "CHACCT050-ML",
      price: 439,
      description: "An edgy accessory with Y2K aesthetic featuring 'BADDIE' letter beads, 8-ball, butterfly, and star charms.",
